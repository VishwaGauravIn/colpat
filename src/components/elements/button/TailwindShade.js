  ...
  return (
    <>
      {colors && (
        ...
        >
          <button className="rounded-full py-3 px-6 text-base font-semibold bg-tint-emerald text-black flex justify-center items-center gap-2 group hover:ring-4 ring-offWhite/40">
