      ...
      <div className="w-full flex justify-center">
        <main className="w-full max-w-5xl flex flex-col items-center justify-center">
          ...
          <div className="flex justify-evenly w-full my-10">
            <button
              className="rounded-full py-3 px-6 text-sm sm:text-base font-semibold bg-tint-teal text-black flex justify-center items-center gap-2 group hover:ring-4 ring-offWhite/40"
            ...
            <button
              className="rounded-full py-3 px-6 text-sm sm:text-base font-semibold bg-tint-green text-black flex justify-center items-center gap-2 group hover:ring-4 ring-offWhite/40"
